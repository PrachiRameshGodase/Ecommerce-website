...
const Header=(props)=> {
  ...
  return (
    <>
       <Navbar fixed="top" className="bg-gradient-to-b from-violet-900 to-pink-400">
        <Container>
            <Navbar.Brand href="#home" className={` text-gray-100 font-bold ${classes.logo}  text-xl`}>Online Shopping</Navbar.Brand>
