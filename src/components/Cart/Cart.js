...
function Cart(props) {
  ...
  async function  fetchCartItems() {
    const response = await axios.get(`https://crudcrud.com/api/4910f3b0671f47b99c71989ddf0486c0/${updatedEmail}`);
...
async function cartItemRemoveHandler(id){
  ...
  await axios.delete(`https://crudcrud.com/api/4910f3b0671f47b99c71989ddf0486c0/${updatedEmail}/${id}`)
